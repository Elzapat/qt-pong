...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Paddle_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Paddle_t qt_meta_stringdata_Paddle = {
    {
QT_MOC_LITERAL(0, 0, 6) // "Paddle"
...
QT_INIT_METAOBJECT const QMetaObject Paddle::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Paddle.data,
    qt_meta_data_Paddle,
    qt_static_metacall,
    nullptr,
    nullptr
